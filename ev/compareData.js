...
async function sendToDiscord(newElement) {
        ...
        embeds: [
            {
                ...
                color: 0xffdd00,
                footer: {
                    text: "Data provided by ChequeMate +EV Bot",
    ...
    try {
        ...
        console.log('New EV opportunity posted to Discord:', embedMessage);
    } catch (error) {
        console.error('Error sending EV opportunity to Discord:', error);
    }
}
